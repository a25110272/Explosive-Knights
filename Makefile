...
CPP_FILES := $(filter-out $(SRC_DIR)/Knight.cpp $(SRC_DIR)/Mapa.cpp $(SRC_DIR)/Menu.cpp $(SRC_DIR)/SeleccionPersonaje.cpp $(SRC_DIR)/MenuArcadePlayers.cpp $(SRC_DIR)/Puerta.cpp $(SRC_DIR)/GestorArcade.cpp,$(wildcard $(SRC_DIR)/*.cpp))
